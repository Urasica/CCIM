...
4. [개발 워크플로](development/workflow.md)와 [로드맵](development/roadmap.md)
5. [평가 계획](evaluation/eval-plan.md)과 [초기 방향 ADR](decisions/ADR-0001-project-direction.md)
...
- 루트의 `DEV_PLAN.md`와 `CCIM_EVIDENCE_MIDDLEWARE_PLAN.md`는 기존 작업 메모를 보존한 것이다. 이후의 기준선은 이 디렉터리의 책임별 문서다.
